    ...
    return (
        <>
            <div className='flex items-center justify-between px-6 md:px-[200px] py-4'>
                ...
                <h3 className='hover:underline'><Link to="/login">Login</Link></h3>
            </div>

            <div className='w-full flex justify-center items-center h-[84vh]'>
                <div className='flex flex-col justify-center items-center space-y-4 w-[80%] md:w-[25%]'>
                    <h1 className='text-xl font-bold text-left'>Signup to Your account</h1>
                    ...
                    <div className='flex justify-center items-center space-x-2'>
                        ...
                        <p className='text-gray-500 hover:text-blue-600 hover:underline'><Link to="/login">login</Link></p>
                    </div>
                </div>
            </div>
