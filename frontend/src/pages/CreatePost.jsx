...
const CreatePost = () => {
    ...
    const deleteCategory = (id) => {
        let updatedCats = cats.filter((item,index)=>{
            return id !== index
        })
        setCats(updatedCats);
    }
        ...
        <div>
            ...
            <div className='px-8 md:px-[200px] mt-8'>
                ...
                <form className='w-full flex flex-col space-y-4 md:space-y-8 mt-4' action="">
                    <input onChange={(e)=> setTitle(e.target.value)} className='px-4 py-2 outline-none' type="text" placeholder='Enter post title...' />
                    ...
                    <textarea onChange={(e)=>setDesc(e.target.value)} rows={15} cols={30} className='px-4 py-2 outline-none' placeholder='Enter post description'></textarea>
